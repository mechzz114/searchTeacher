...
<?php
$sql = "SELECT pid, pname, pemail, pcourse, puniversity, rid, p_fk, rdate, rrating, rdifficulty, rtag,   ragain, rcomments from tblprofessor_FL12733 JOIN tblrating_FL12733 ON tblprofessor_FL12733.pid = tblrating_FL12733.p_fk where rid=$rid";
