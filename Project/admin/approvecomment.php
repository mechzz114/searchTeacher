...
if (isset($_GET['approve'])) {
    ...
    $conn->query("UPDATE tblcomments_FL12733 SET capproved = 1 WHERE cid = $id");
}

// Delete comment
if (isset($_GET['delete'])) {
    $id = intval($_GET['delete']);
    $conn->query("DELETE FROM tblcomments_FL12733 WHERE cid = $id");
}

// Fetch unapproved comments
$sql = "SELECT * FROM tblcomments_FL12733 WHERE capproved = 0 ORDER BY cdate DESC";
