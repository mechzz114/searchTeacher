...
?>	
				...
				$sql = "SELECT pid, pname, pcourse, puniversity,p_fk, rdate, rrating, rdifficulty, rtag,   ragain, rcomments from tblprofessor_FL12733 JOIN tblrating_FL12733 ON tblprofessor_FL12733.pid = tblrating_FL12733.p_fk Where tblrating_FL12733.p_fk=$id order by rid desc";
				//echo $sql;
